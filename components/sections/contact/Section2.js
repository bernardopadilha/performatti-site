...
export default function Section2() {
  return (
    <section className="section-box">
      <div className="container flex-center gap-40">
        <div className="contact-container col-lg-7 mb-30 relative-top-170">
          <h2 className="mb-20 mt-20">Fale com um especialista</h2>
